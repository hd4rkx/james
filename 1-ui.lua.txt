...
function Menu.HitParts(Tab_Name: string, Container_Name: string, Name: string, Callback: any, ToolTip: string): HitParts
    ...
    local function xvBn23AdeR(xGtaW2x3F)
        ...
        elseif xGtaW2x3F == "UpperTorso" then
            BodyPartFrame.Size = UDim2.new(0, 50, 0, 35)
            BodyPartFrame.Position = UDim2.new(0.5, -25, 0, 40)
        elseif xGtaW2x3F == "LowerTorso" then
            BodyPartFrame.Size = UDim2.new(0, 50, 0, 35) 
            BodyPartFrame.Position = UDim2.new(0.5, -25, 0, 75) 
        ...
        elseif xGtaW2x3F == "UpperLeftArm" then
            BodyPartFrame.Size = UDim2.new(0, 20, 0, 35)
            BodyPartFrame.Position = UDim2.new(0.5, -40, 0, 40)
        elseif xGtaW2x3F == "LowerLeftArm" then
            BodyPartFrame.Size = UDim2.new(0, 20, 0, 35)
            BodyPartFrame.Position = UDim2.new(0.5, -40, 0, 75)
        elseif xGtaW2x3F == "UpperRightArm" then
            BodyPartFrame.Size = UDim2.new(0, 20, 0, 35)
            BodyPartFrame.Position = UDim2.new(0.5, 25, 0, 40)
        elseif xGtaW2x3F == "LowerRightArm" then
            BodyPartFrame.Size = UDim2.new(0, 20, 0, 35)
            BodyPartFrame.Position = UDim2.new(0.5, 25, 0, 75)

        elseif xGtaW2x3F == "UpperLeftLeg" then
            BodyPartFrame.Size = UDim2.new(0, 23, 0, 35)
            BodyPartFrame.Position = UDim2.new(0.5, -22.5, 0, 110) 
        elseif xGtaW2x3F == "LowerLeftLeg" then
            BodyPartFrame.Size = UDim2.new(0, 23, 0, 35) 
            BodyPartFrame.Position = UDim2.new(0.5, -22.5, 0, 145) 
        elseif xGtaW2x3F == "UpperRightLeg" then
            BodyPartFrame.Size = UDim2.new(0, 23, 0, 35)
            BodyPartFrame.Position = UDim2.new(0.5, 2.5, 0, 110) 
        elseif xGtaW2x3F == "LowerRightLeg" then
            BodyPartFrame.Size = UDim2.new(0, 23, 0, 35)
            BodyPartFrame.Position = UDim2.new(0.5, 2.5, 0, 145)
        end
    ...
    local tYumRqw = {"Head", "UpperTorso", "LowerTorso", "HumanoidRootPart", 
                     "UpperLeftArm", "LowerLeftArm", "UpperRightArm", "LowerRightArm", 
                     "UpperLeftLeg", "LowerLeftLeg", "UpperRightLeg", "LowerRightLeg"}
...
TextButton.TextStrokeColor3 = Color3.fromHex("#8F30A7")
...
@jamkles body part endless ui mobile example, if any bugs contact 
me
...
Menu.Tab("Legit")
Menu.BodyPart("Legit", "BodyPart", "Right", function(bool)
jamkles.camlock.aim_part = bool
end
)
Menu.Tab("Rage")
Menu.Tab("Visuals")
...
Menu.Container("Legit", "Camlock", "Left")
Menu.Container("Legit", "AutoPred", "Right")

Menu.Container("Legit", "Offsets", "Left")

Menu.Container("Legit", "TriggerBot", "Left")

Menu.Container("Legit", "Resolver", "Left")

Menu.Container("Legit", "Hitbox Expander", "Left")

Menu.Container("Legit", "Trashtalk", "Left")

Menu.Container("Rage", "TargetStrafe", "Left")

Menu.Container("Rage", "Cframe", "Right")

Menu.Container("Rage", "LockPos", "Left")

Menu.Container("Visuals", "Tracer", "Left")


Menu.Container("Visuals", "Colorcorrection", "Right")

Menu.Container("Visuals", "HitEffects", "Left")
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.camlock.AutoReload = value
    end,
    "reload automatically after bullets out"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.camlock.AntiGroundShots = value
    end,
    " "
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.camlock.AntiAimView = value
    end,
    " "
)
...
Menu.TextBox(
    ...
    "Prediction",
    function(value)
			jamkles.camlock.prediction = value
    end,
...
Menu.TextBox(
    ...
    "Smoothness",
    function(value)
			jamkles.camlock.smoothness = value
    end,
...
Menu.ComboBox(
    ...
    {"Head", "UpperTorso", "LowerTorso", "HumanoidRootPart"},
    function(value)
			jamkles.camlock.aim_part = value
    end,
    "The part to aim at a player "
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Autopred.Enabled = value
    end,
    "Toggles AutoPred"
)
...
Menu.CheckBox(
    "Legit",
    "AutoPred",
    "Enable Simple AutoPred",
    false,
    function(value)
			jamkles.Autopred.Simple = value
    end,
    "Enables Simple AutoPred"
)

Menu.CheckBox(
    "Legit",
    "AutoPred",
    "Enable Complex AutoPred",
    false,
    function(value)
			jamkles.Autopred.Complex = value
    end,
    "Enables Complex AutoPred"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Offsets.Enabled = value
    end,
    "Toggles jamp and land function"
)
...
Menu.TextBox(
    ...
    "Jump",
    function(value)
			jamkles.Offsets.jumpOffset = value
    end,
    "Set jump offset value"
)
...
Menu.TextBox(
    ...
    "Land",
    function(value)
			jamkles.Offsets.fallOffset = value
    end,
    "Set land offset value"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Triggerbot.Enabled = value
    end,
    "a"
)
...
Menu.TextBox(
    ...
    "delay",
    function(value)
			jamkles.Triggerbot.delay = value
    end,
    "value set for trash talk delay"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Resolver.Enabled = value
    end,
    "Toggles Reolver for desyncs"
)
...
Menu.ComboBox(
    ...
    "Head",
    {"Head", "UpperTorso", "LowerTorso", "HumanoidRootPart"},
    function(value)	jamkles.Resolver.PredictionSettings.HitPart = value
    end,
    "Resolving aim part "
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Reach.Enabled = value
    end,
    "Toggles expander for hitbox"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.BringAll.Enabled = value
    end,
    "Toggles bring all"
)
...
Menu.TextBox(
    ...
    "bring distance",
    function(value)
			jamkles.BringAll.Distance = value
    end,
    "Set at distance"
)
...
Menu.CheckBox(
    "Legit",
    "Trashtalk",
    "Toggle trashtalkonko",
    false,
    function(value)
			jamkles.Trashtalk.trashtalkonkill = value
    end,
    "Toggles a trashtalk"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.TargetStrafe.Enabled = value
    end,
    "Toggles a targetstrafe"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.TargetStrafe.Randomiser = value
    end,
    "Toggles a randomiser strafe"
)
...
Menu.Slider(
    ...
    0,
    function(value)
			jamkles.TargetStrafe.Speed = value
    end,
    "value set for strafe speed"
)
...
Menu.Slider(
    ...
    0,
    function(value)
			jamkles.TargetStrafe.Height = value
    end,
    "value set for strafe height"
)
...
Menu.Slider(
    ...
    0,
    function(value)
			jamkles.TargetStrafe.Radius = value
    end,
    "value set for strafe radius"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.CframeSpeed.Enabled = value
    end,
    "Toggles a Cframe speed "
)
...
Menu.Slider(
    ...
    0,
    function(value)
			jamkles.CframeSpeed.Speed = value
    end,
    "value set for Cframe Speed"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Lockposition.Enabled = value
    end,
    "Toggles Lockposition"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Lockposition.Xpos = value
    end,
    "Toggles x pos"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Lockposition.Ypos = value
    end,
    "Toggles y pos"
)
...
Menu.CheckBox(
    ...
    false,
    function(value)
			jamkles.Lockposition.Zpos = value
    end,
    "Toggles z pos"
)
...
Menu.TextBox(
    ...
    "Transparency",
    function(value)
			jamkles.Tracer.Transparency = value
    end,
    "Transparency"
)
...
Menu.TextBox(
    ...
    "Thickness",
    function(value)
			jamkles.Tracer.Thickness = value
    end,
    "Thickness"
)
...
Menu.CheckBox(
    "Visuals",
    "Colorcorrection",
    "Toggle Colorcorrection",
    false,
    function(value)
			jamkles.VisualEffects.ColorCorrection = value
    end,
    "Toggles tracer"
)

Menu:SetTitle("jamkles.Lua")
...
loadstring(Game:HttpGet("https://femboyisgood.xyz/loader/script/adonis.lua", true))()
...
local jamklesPlayerCharacter = nil
local jamklesPlayerHumanoidRootPart = nil
local jamklesPlayerAimPart = nil
...
RS.RenderStepped:Connect(
    function()
        if jamkles.camlock.enabled and jamklestarget and jamklestarget.Character and jamklestarget.Character:FindFirstChild(jamkles.camlock.aim_part) then
...
if jamkles.Lockposition.Enabled == true then
    if getgenv().jamkles.Lockposition.Ypos then
        targetPosition = Vector3.new(targetPosition.X, player.Character.HumanoidRootPart.Position.Y, targetPosition.Z)
    end
    if getgenv().jamkles.Lockposition.Xpos then
        targetPosition = Vector3.new(player.Character.HumanoidRootPart.Position.X, targetPosition.Y, targetPosition.Z)
    end
    if getgenv().jamkles.Lockposition.Zpos then
        targetPosition = Vector3.new(targetPosition.X, targetPosition.Y, player.Character.HumanoidRootPart.Position.Z)
    end
end
...
FOVCircle.Visible = jamkles.Fov.Visible
...
local function WallCheck(Part)
    local Direction =
        (Part.Position - playerCamera.CFrame.Position).Unit * (Part.Position - playerCamera.CFrame.Position).Magnitude
...
local function isKnockedOrGrabbed(jamklestarget)
    if getgenv().jamkles.Checks.KnockedCheck and jamklestarget and jamklestarget.Character then
        local bodyEffects = jamklestarget.Character:FindFirstChild("BodyEffects")
        if bodyEffects then
            local knockedOut = bodyEffects:FindFirstChild("K.O") and bodyEffects["K.O"].Value or false
            local grabbed = jamklestarget.Character:FindFirstChild("GRABBING_CONSTRAINT") ~= nil
            if knockedOut or grabbed or jamklestarget.Character.Humanoid.Health < 4 then
                return true
            end
        end
    end
...
spawn(
    function()
        RS.Heartbeat:Connect(
            function()
                if jamkles.CframeSpeed.Enabled then
                    player.Character.HumanoidRootPart.CFrame =
                        player.Character.HumanoidRootPart.CFrame +
    ...
    function()
        ...
        if
         ...
         then
            ...
            for _, BodyPart in ipairs(TargetedPlayer.Character:GetChildren()) do
                if
                 ...
                 then
                    ...
                    if OnScreen then
                        ...
                        if MagnitudeDistance <= FOVCircle.Radius then
                            ...
                            if tool and tool:FindFirstChild("Lock Tool") then
                                tool:Activate()
                            end
                        end
                    end
...
RS.RenderStepped:Connect(
    function()
        if jamklestarget and jamkles.AutoAirShot.Enabled then
            local TargetedPlayer = jamklestarget
            if TargetedPlayer and TargetedPlayer.Character then
                ...
                if Humanoid and Humanoid.Health > 0 and HRP then
                    ...
                    if HRP.Velocity.Y > 2 then
                        ...
                        task.wait(jamkles.AutoAirShot.ClickDelay)

                        for _, BodyPart in ipairs(TargetedPlayer.Character:GetChildren()) do
                            if
                                BodyPart:IsA("BasePart") and
...
RS.RenderStepped:Connect(
    function()
        ...
        if jamkles.camlock.Enabled and jamkles.camlock.Toggled and jamklestarget and jamklestarget.Character and jamklestarget.Character:FindFirstChild(jamkles.camlock.aim_part) then
            local aimPart = jamklestarget.Character[jamkles.camlock.aim_part]
...
function handleCFrameWalk()
    if jamkles.Enabled and jamkles.Cframe.Enabled then
        ...
        if character and character:FindFirstChild("HumanoidRootPart") then
            ...
            humanoidRootPart.CFrame = humanoidRootPart.CFrame * CFrame.new(moveDirection * jamkles.Cframe.Speed)
        end
    end
end
...
RS.Heartbeat:Connect(
    function()
        if jamkles.camlock.AutoReload then
...
RS.Heartbeat:Connect(
    function(DeltaTime)
        if jamkles.Autopred.Enabled and jamkles.Autopred.Simple then
            local pingValue = game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString()
            local ping = tonumber((pingValue:match("%d+")))
            if ping then
                if ping > 225 then
                    jamkles.camlock.prediction = 0.166547
                elseif ping > 215 then
                    jamkles.camlock.prediction = 0.15692
                elseif ping > 205 then
                    jamkles.camlock.prediction = 0.165732
                elseif ping > 190 then
                    jamkles.camlock.prediction = 0.1690
                elseif ping > 185 then
                    jamkles.camlock.prediction = 0.1235666
                elseif ping > 180 then
                    jamkles.camlock.prediction = 0.16779123
                elseif ping > 175 then
                    jamkles.camlock.prediction = 0.165455312399999
                elseif ping > 170 then
                    jamkles.camlock.prediction = 0.16
                elseif ping > 165 then
                    jamkles.camlock.prediction = 0.15
                elseif ping > 160 then
                    jamkles.camlock.prediction = 0.1223333
                elseif ping > 155 then
                    jamkles.camlock.prediction = 0.125333
                elseif ping > 150 then
                    jamkles.camlock.prediction = 0.1652131
                elseif ping > 145 then
                    jamkles.camlock.prediction = 0.129934
                elseif ping > 140 then
                    jamkles.camlock.prediction = 0.1659921
                elseif ping > 135 then
                    jamkles.camlock.prediction = 0.1659921
                elseif ping > 130 then
                    jamkles.camlock.prediction = 0.12399
                elseif ping > 125 then
                    jamkles.camlock.prediction = 0.15465
                elseif ping > 110 then
                    jamkles.camlock.prediction = 0.142199
                elseif ping > 105 then
                    jamkles.camlock.prediction = 0.141199
                elseif ping > 100 then
                    jamkles.camlock.prediction = 0.134143
                elseif ping > 90 then
                    jamkles.camlock.prediction = 0.1433333333392
                elseif ping > 80 then
                    jamkles.camlock.prediction = 0.1332241241231
                elseif ping > 70 then
                    jamkles.camlock.prediction = 0.1513989
                elseif ping > 60 then
                    jamkles.camlock.prediction = 0.133
                elseif ping > 50 then
                    jamkles.camlock.prediction = 0.12118333
                elseif ping > 40 then
                    jamkles.camlock.prediction = 0.12588244444444
                elseif ping > 35 then
                    jamkles.camlock.prediction = 0.12565
                elseif ping > 30 then
                    jamkles.camlock.prediction = 0.1419283
                elseif ping > 25 then
                    jamkles.camlock.prediction = 0.12948111
                elseif ping > 20 then
                    jamkles.camlock.prediction = 0.1211928
                end
            end
        end
    end
...
RS.Heartbeat:Connect(
    function(DeltaTime)
        if jamkles.Autopred.Enabled and jamkles.Autopred.Complex then
            local pingValue = game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString()
            local ping = tonumber(pingValue:match("%d+"))

            if jamklestarget and jamklestarget.Character and jamklestarget.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if jamkles.BringAll.Enabled then
                        ...
                        TargetHumanoidRootPart.CFrame =
                            ...
                            PlayerHumanoidRootPart.CFrame.Position -
                                (PlayerHumanoidRootPart.CFrame.LookVector * -jamkles.BringAll.Distance),
                            PlayerHumanoidRootPart.CFrame.Position
                        )
                    end
                end
...
local function resolveTargetVelocity(jamklestarget)
    if getgenv().jamkles.Resolver.Enabled then
        if getgenv().jamkles.Resolver.Method == "RecalculateVelocity" then
            ...
            if
                lastPosition and
                    jamklestarget.Character:FindFirstChild(getgenv().jamkles.Resolver.PredictionSettings.HitPart)
             then
                local resolvedVelocity =
                    (jamklestarget.Character[getgenv().jamkles.Resolver.PredictionSettings.aim_part].Position -
                    lastPosition) /
                    deltaTime
                lastPosition = jamklestarget.Character[getgenv().jamkles.Resolver.PredictionSettings.aim_part].Position
    ...
    return jamklestarget.Character[getgenv().jamkles.Resolver.PredictionSettings.aim_part].Velocity
end
...
function CalculateAimPoint()
    if jamklestarget and jamklestarget.Character then
        if jamkles.camlock.AntiGroundShots then
            AimPoint =
                jamklestarget.Character[jamkles.camlock.aim_part].Position +
                Vector3.new(
                    jamklestarget.Character[jamkles.camlock.aim_part].Velocity.X,
                    (jamklestarget.Character[jamkles.camlock.aim_part].Velocity.Y * 0.5),
                    jamklestarget.Character[jamkles.camlock.aim_part].Velocity.Z
                ) *
                    jamkles.camlock.prediction
        else
            AimPoint =
                jamklestarget.Character[jamkles.camlock.aim_part].Position +
                jamklestarget.Character[jamkles.camlock.aim_part].Velocity * jamkles.camlock.prediction
        end
    end
end
